...
import com.atom.android.lebo.databinding.ItemAuthorBinding
import com.atom.android.lebo.model.Author
import com.atom.android.lebo.utils.extensions.loadImage

class ListAdapterAuthor(private val onClick: (Author) -> Unit) :
    ...
    inner class ViewHolder(val binding: ItemAuthorBinding) : BaseViewHolder<Author>(binding) {
